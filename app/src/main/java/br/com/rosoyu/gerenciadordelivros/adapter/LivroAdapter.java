package br.com.rosoyu.gerenciadordelivros.adapter;
...
public class LivroAdapter extends RecyclerView.Adapter<LivroAdapter.LivroHolder> {
    ...
    public LivroAdapter(List<Livro> livroList, Context context, OnLivroListener onLivroListener) {
